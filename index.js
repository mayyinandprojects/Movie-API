...
let allowedOrigins = ['http://localhost:8080', 'http://localhost:4200', 'http://movie-api-4o5a.onrender.com', 'http://localhost:1234', 'http://myflixmoviedatabase.netlify.app', 'https://myflixmoviedatabase.netlify.app', 'https://mayyinandprojects.github.io'];
  ...
  await Users.findOneAndDelete({ username: req.params.username })
    .then((user) => {
      if (!user) {
        ...
        res.status(200).send('{"response":"' + req.params.username + ' was deleted."}');
      }
    })
    .catch((err) => {
      console.error(err);
